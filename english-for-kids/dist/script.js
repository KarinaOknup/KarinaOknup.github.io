...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    value: function createGame() {
      ...
      var numberOfStar = document.querySelectorAll('.star').length;
      ...
      document.querySelectorAll('.card').forEach(function (e) {
        e.addEventListener('click', function () {
          if (e.id == rN[iRC]) {
            ...
            audioTest = new Audio("".concat(arrA[rN[iRC]]));
            audioTest.play();
            correct.play();

            var _star = document.createElement('img');

            _star.className = 'star win';
            _star.src = './img/star-win.svg';
            e.style = 'opacity:0.5;';
            ...
            _star2.className = 'star wrong';
            _star2.src = './img/star.svg';
            _star2.className = 'star';
            document.querySelector('#scale').prepend(_star2);
            if (document.querySelectorAll('.star').length == 10) document.querySelectorAll('.wrong').forEach(function (e) {
              return e.remove();
            });
          }
